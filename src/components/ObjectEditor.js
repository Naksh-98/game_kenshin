...
export default function ObjectEditor({ onSave, initialData, onClose, onDelete }) {
    ...
    useEffect(() => {
        ...
        // Intercept native touch events for range inputs so BScroll ignores them
        const stopProp = (e) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col border-t md:border-t-0 md:border-r border-gray-200 bg-white">
